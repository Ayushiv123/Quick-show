...
import { Menu as MenuIcon, Search as SearchIcon, Ticket, TicketPlus, X as XIcon } from 'lucide-react'
        ...
        <SearchIcon className='max-md:hidden w-6 h-6 cursor-pointer' />
        {
         ...
         <UserButton>
          <UserButton.MenuItems>
            ...
            My Booking' labelIcon={<TicketPlus width={15}/>} onClick={()=>navigate('/my-Booking')}/>
          </UserButton.MenuItems>
         </UserButton>
          )
        }
